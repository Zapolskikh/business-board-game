  ...
  <main>
    <section id="goal">
      ...
      <ul>
        ...
        <li><b>Объекты</b> — половина цены объекта (округление вниз) + 2 очка за улучшение (автоматизацию либо модернизацию).</li>
    ...
    <section id="economy">
      ...
      <h3>Улучшения объекта</h3>
      <p>У объекта может быть <b>только одно улучшение</b> — либо автоматизация, либо модернизация. Выбор окончательный: улучшенный объект больше улучшить нельзя, а сменить тип улучшения невозможно.</p>
      <div class="cols">
      ...
      <p>Продажа объекта возвращает <code>⌊цена/2⌋ + 2 за улучшение</code> и освобождает слот.</p>
