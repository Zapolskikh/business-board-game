...
import { campaignTiers, crisisPrInfluence, influencePerPoint, marketRotationSize, marketRerollCost, moneyPerPoint, projectPerkText, projectRequirementText, projectRerollMoney, rarityLabels } from "./gameUi";
...
<div class="layout">
  ...
  <main>
    ...
    <section id="flow">
      ...
      <p><b>Действия</b> тратятся на что угодно: город, роли, карты, серые операции, защиту, покупки. Есть и бесплатные команды, которые действий не расходуют вовсе: продажа объекта, реролл рынка, розыгрыш и сброс карты.</p>
