...
const roleGuides: Record<string, RoleGuide> = {
  ...
  fraudster: {
    ...
    perks: [
      ...
      "<b>Мастер серых операций.</b> Шанс успеха любой серой операции выше на <b>20 п.п.</b>, и ещё на <b>10 п.п.</b>, если у вас есть активный объект Технокластера. Итоговый шанс не выше 90%.",
  ...
  <main>
    ...
    <section id="grey">
      ...
      <table>
        ...
        <tbody>
          <tr><td class="name"><b>Отмывание</b></td><td>Серый сектор</td><td class="num">80%</td><td>(${meta.scoring?.laundering_base_cost ?? 4} + ⌊раунд/2⌋)$ → (${meta.scoring?.laundering_base_gain ?? 2} + ⌊раунд/3⌋)◆</td><td>+1 (провал: остальные +2)</td></tr>
          <tr><td class="name"><b>Контрабанда</b></td><td>Серый сектор</td><td class="num">70%</td><td>украсть до (3 + ⌊раунд/2⌋)$ у цели</td><td>+1 (провал: остальные +2)</td></tr>
          <tr><td class="name"><b>Памп и дамп</b></td><td>Технокластер, Серый сектор</td><td class="num">60%</td><td>+(6 + раунд)$, лидер −(2 + ⌊раунд/2⌋)$</td><td>+1 (провал: остальные +3)</td></tr>
          <tr><td class="name"><b>Взлом</b></td><td>Технокластер, Серый сектор</td><td class="num">55%</td><td>украсть до ${meta.scoring?.hack_influence_steal ?? 4}◆ у цели</td><td>+2 (провал: остальные +3)</td></tr>
          <tr><td class="name"><b>Слив компромата</b></td><td>Серый сектор, Административный квартал</td><td class="num">70%</td><td>${meta.scoring?.compromat_influence ?? 3}◆ → цель теряет роль (раз в раунд)</td><td>+2 (провал: остальные +3)</td></tr>
        </tbody>
      </table>
