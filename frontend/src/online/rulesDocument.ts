...
<div class="layout">
  ...
  <main>
    ...
    <section id="grey">
      ...
      <p>Серые операции открывает <b>район</b>, а не отдельная карточка: достаточно любого активного объекта нужного района, роль не требуется. Каждая стоит 1 обычное действие, и <b>за ход можно провести только одну любую операцию</b>. Серый сектор открывает все пять; Технокластер — «Памп и дамп» и «Взлом»; Административный квартал — «Слив компромата».</p>
      <table>
      ...
      <p>Аферист повышает шанс успеха на 30 п.п. без всяких условий (потолок 90%) и получает влияние за отставание в рейтинге. Некоторые серые объекты («офшор») снижают начисляемые скандалы — и теперь это работает как при успехе, так и при провале.</p>
      ...
      <div class="box"><h4>Свои скандалы Крыша не отменяет</h4><p>Крыша защищает только от чужих эффектов. Скандал, который вы навлекли сами — серой операцией, покупкой серого объекта, собственной публикацией, — начисляется всегда, даже если у вас есть Крыша. Иначе серый слой можно было бы крутить бесплатно.</p></div>
